...
//    public abstract class CartesianModel<TKey, TType> : MultiPlotModel<TKey, double, TType> where TType : IPoint<TKey>
//    {
...
//        //protected override void AddToDataPoints(ICollection<KeyValuePair<TKey, KeyValuePair<double, double>>> items)
//        //{
//        //    try
//        //    {
//        //        min = Math.Min(items.Min(a => a.Value.Key), min);
//        //        max = Math.Max(items.Max(a => a.Value.Key), max);
...
//        //                    DataPoints[item.Key] = new RankedMap<double, double>();
