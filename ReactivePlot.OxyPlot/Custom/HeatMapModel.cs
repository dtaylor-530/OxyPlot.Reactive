...
{
    public class HeatMapModel : IObserver<KeyValuePair<(string, string), double>>, IMixedScheduler
    {
        ...
        protected readonly OxyPlotModel plotModel;
        ...
        public HeatMapModel(OxyPlotModel plotModel, string? hAxisKey = null, string? vAxisKey = null, IComparer<string>? hNamesComparer = null,
        ...
        private static OxyPlotModel CreateModel(OxyPlotModel plotModel, string? horizontalAxis, string? verticalAxis)
        {
        ...
        private static void AlterModel(OxyPlotModel plotModel, double min, double max, string[] horizontalNames, string[] verticalNames)
        {
